...
String rawGitStamp(bool generateFlutterFiles, bool generateFlutterIcon) => '''
library git_stamp;
...
${(generateFlutterFiles || generateFlutterIcon).enabled}export 'src/ui/git_stamp_icon.dart';
